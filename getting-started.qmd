...
You do not need prior experience with Git, Python, Visual Studio Code or Quarto. Each section provides step-by-step instructions and explains what you should expect to see before moving on to the next step.
...
1. On the right-hand side of the repository home page, locate the **About** section and click the **Settings** <span aria-hidden="true">⚙️</span> icon.

<span style="color: red; font-weight: bold;">Screenshot: Repository home page showing the About settings button.</span>

2. In the **Edit repository details** dialog:
...
You now have a local copy of your course repository. In the next section, you will open it in VS Code and prepare it for editing.
...
1. In the explorer panel in VS Code, open the file `_sections/hero.qmd`.
...
### Open Source Control
The next steps will upload the small change you made  to your GitHub repository so that it becomes available to your collaborators and can be published on your course website.

In VS Code, this is done from the **Source Control** panel. To open it, click the **Source Control** icon in the Activity Bar on the left-hand side of the window.
